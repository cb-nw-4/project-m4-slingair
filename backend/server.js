...
const { getFlights, getFlight, addReservations, getReservations, getSingleReservation, deleteReservation, updateReservation } = require("./handlers");
...
express()
  ...
  .delete('/deleteReservations/:id', deleteReservation)
